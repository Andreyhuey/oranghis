    ...
    async function fetchData() {
      ...
      try {
        const response = await fetch(
          `https://raw.githubusercontent.com/Andreyhuey/my-app/master/src/data/irs.json`,
          {
            headers: {
      ...
      <section className="container-fluid">
        <div className="">
          <h3 className="text-bold fw-bold text-center py-3">
            ODCHC Internal Revenue Service Beneficiaries
          </h3>
          <form
          ...
          >
            <input
              ...
              type="search"
              value={searchTerm}
              placeholder="GOV ID or NAME e.g IRS/P.0620 or 0620"
